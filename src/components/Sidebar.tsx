          ...
          <nav className="flex-1 px-4 py-6">
            <ul className="space-y-2">
              ...
              <li>
                <Link
                  to="/sigarf"
                  className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 ${location.pathname === '/sigarf'
                      ? 'bg-blue-700 text-white'
                      : 'text-gray-300 hover:bg-blue-800 hover:text-white'
                    }`}
                  onClick={closeSidebar}
                >
                  <Shield size={20} />
                  <span className="font-medium">SIGARF</span>
                </Link>
              </li>
              <li>
                <Link
                  to="/cautela"
                  className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 ${location.pathname === '/cautela'
                      ? 'bg-blue-700 text-white'
                      : 'text-gray-300 hover:bg-blue-800 hover:text-white'
                    }`}
                  onClick={closeSidebar}
                >
                  <Car size={20} />
                  <span className="font-medium">CAUTELA</span>
                </Link>
              </li>
            </ul>
          </nav>
